...
for num in ['60', '120', '180', '240', '300']:
    ...
    train_dataset = indirectTrocarDataset(train_path, WINDOW, SKIP, in_joints, num=n, filter_signal=f)
    val_dataset = indirectTrocarDataset(val_path, WINDOW, SKIP, in_joints, num=n, filter_signal=f)
