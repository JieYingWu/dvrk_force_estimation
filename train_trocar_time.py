...
is_rnn = False
net = 'ff'
folder = 'ff/no_cannula'
model = 'filtered_torque_30s'
j = int(sys.argv[1])
...
for e in range(epoch, epochs + 1):
    ...
    for i, (position, velocity, torque, jacobian, data_time, fs_pred) in enumerate(train_loader):
