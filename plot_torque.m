...
if strcmp(test_folder, 'test')
    ...
    fs_pred_path = ['../data/csv/', test_folder, '/', data, '/', contact, '/ff_pred_filtered_torque.csv'];
else
    joint_path = ['../data/csv/', test_folder, '/', data, '/joints/'];
    fs_pred_path = ['../data/csv/', test_folder, '/', data, '/ff_pred_filtered_torque.csv'];
end
pred_path = ['../data/csv/', test_folder, '/', data, '/', contact, '/', 'no_contact_pred.csv'];
