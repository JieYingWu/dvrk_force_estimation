...
train_dataset = indirectTrocarDataset(train_path, WINDOW, SKIP, in_joints, is_rnn=is_rnn, filter_signal=f)
val_dataset = indirectTrocarDataset(val_path, WINDOW, SKIP, in_joints, is_rnn=is_rnn, filter_signal=f)
...
#            pred = networks[j](posvel) * max_torque[j] + fs_pred[:,[j]]
